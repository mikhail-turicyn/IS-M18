 ...
 */
public class JFreeBarChartExample extends ApplicationFrame {

	public JFreeBarChartExample(String title) {
		super(title);

		var dataset = createCategoryDatasetOne();
		var chart = createBarChart(dataset);
